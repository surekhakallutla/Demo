...
insert into employee_payroll (employee_name , salary, start_date) values('ABC', 1000.48, '2022-03-03'),
									('DEF', 1010.48, '2022-03-04'),
                                    ('GHI', 1020.58, '2022-03-02'),
                                    ('JKL', 1030.29, '2022-02-03');
